...
- [x] Add expense categories and allow users to filter expenses by category.
- [x] Allow users to set a budget for each month and show a warning when the user exceeds the budget.
- [x] Allow users to export expenses to a CSV file.
